...
{//Catalog herkeisn eerişebileceği ana sayfa niteliğinde course'ların listelendiği bir yer olacak
    //burada kullanıcı girişine değil client-creadential token'lara ihtiyaç var üyelik gerektirmeyen yani
    public class CatalogService : ICatalogService
    {
        ...
        public async Task<bool> UpdateCourseAsync(CourseUpdateInput courseUpdateInput)
        {
            ...
            if (resultPhotoService != null)
            {
                await _photoStockService.DeletePhoto(courseUpdateInput.Picture);//Update.cshtml hidden'dan geliyor.
